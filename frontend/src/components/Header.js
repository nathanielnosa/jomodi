                    ...
                    <div className="fixed inset-0 z-40 flex">
                        ...
                        >
                            <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                                            ...
                                            <Tab.Panel key={category.name} className="space-y-10 px-4 pb-8 pt-10 z-50">
                                                <div className="grid grid-cols-2 gap-x-4 z-50">
                                                    {category.featured.map((item) => (
                                                        <div key={item.name} className="group relative text-sm z-50">
                                ...
                                <div >
                                    <Menu as="div" className="relative inline-block text-right -m-2 block p-2">
                                        <div>
                    ...
                    <div className="border-b border-gray-200">
                        <div className="flex h-16 items-center">
                            ...
                            <div className="ml-4 flex lg:ml-0">
                                <a href="#">
                                    <span className="sr-only">Jomodi</span>
                                    <img
                            ...
                            <div className="ml-auto flex items-center">
                                ...
                                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                                    ...
                                    <a href="#" className="text-sm font-medium text-dark-700 hover:text-gray-800">
                                        Become a Seller
                                    </a>
                                </div>
